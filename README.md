Objective: Your task is to create a simple Shopping Cart project using HTML, CSS( tailwind or bootstrap) & JavaScript. 
...
Calculate Total: Automatically update the total price as items are added or their quantities are updated. Responsive Design: Ensure the cart and product display adapt to different screen sizes. 
